...
public class CustomerOrder {
    ...
    /**
     * Public, customer-facing order identifier (e.g. "STP-A7K9P3M2").
     * Generated by {@link com.shoestore.service.OrderNumberService} during
     * checkout; the numeric {@link #id} is still the FK target and lookup
     * token subject internally.
     */
    @Column(name = "order_number", nullable = false, unique = true, length = 16, updatable = false)
